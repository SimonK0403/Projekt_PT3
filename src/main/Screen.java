...
public class Screen {
	...
	public JButton back = new JButton("<< Zur�ck");
	...
	public DefaultTableModel roadTableModel = new DefaultTableModel(10, 10); // Declared separately to save the contents
																				// on page reload
	...
	public void createMainScreen() {
		...
		roads = new JButton("Stra�enanbindung");
		c.gridy = 0;
	...
	public void createRoadScreen() {
		...
		deleteRoadTable = new JButton("L�schen");
		d.gridy = 5;
	...
	public void createWaterScreen() {
		...
		waterNeededDesc = new JLabel("Ben�tigtes Wasser in m�/s:");
		d.gridy = 0;
		...
		deleteWaterTable = new JButton("L�schen");
		d.gridy = 7;
	...
	public void createElectricityScreen() {
		...
		deleteElecTable = new JButton("L�schen");
		d.gridy = 5;
	...
	public void createFireworksScreen() {
		...
		deleteFireworksTable = new JButton("L�schen");
		d.gridy = 5;
	...
	public void createInvitationsScreen() {
		...
		deleteInvitationsTable = new JButton("L�schen");
		d.gridy = 5;
	...
	public void createTrafficScreen() {
		...
		deleteTrafficTable = new JButton("L�schen");
		d.gridy = 5;
	...
	public void createEmployeesScreen() {
		...
		deleteEmployeesTable = new JButton("L�schen");
		d.gridy = 5;
	...
	// Places a Button to the main Menu on the specified JPanel that has a
	// BorderLayout
